...
state("Froghop", "2.4.6.0")
{
	int room : 0x0089B4C8;
	double gameTimer : 0x006715A0, 0x1F18, 0x48, 0x10, 0x60, 0xF0;
	double isPaused : 0x006715A0, 0x1F18, 0x48, 0x10, 0x60, 0x30;
	double levelComplete : 0x006715A0, 0x1F18, 0x48, 0x10, 0x60, 0x10;
	double gemCount : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00;
	double gem1 : 0x0068A9A0, 0x48, 0x10, 0x1400, 0x00, 0x90, 0x00;
	double gem2 : 0x0068A9A0, 0x48, 0x10, 0x1400, 0x00, 0x90, 0x10;
	double gem3 : 0x0068A9A0, 0x48, 0x10, 0x1400, 0x00, 0x90, 0x20;
	double gem4 : 0x0068A9A0, 0x48, 0x10, 0x1400, 0x00, 0x90, 0x30;
	double gem5 : 0x0068A9A0, 0x48, 0x10, 0x1400, 0x00, 0x90, 0x40;
}

state("Froghop", "2.4.5.0")
{
	int room : 0x0089B4C8;
	double gameTimer : 0x006715A0, 0x1F18, 0x48, 0x10, 0x40, 0x100;
	double isPaused : 0x006715A0, 0x1F18, 0x48, 0x10, 0x40, 0x40;
	double levelComplete : 0x006715A0, 0x1F18, 0x48, 0x10, 0x40, 0x20;
	double gemCount : 0x0068A9A0, 0x48, 0x10, 0x1DE0, 0x00;
	double gem1 : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00, 0x90, 0x00;
	double gem2 : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00, 0x90, 0x10;
	double gem3 : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00, 0x90, 0x20;
	double gem4 : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00, 0x90, 0x30;
	double gem5 : 0x0068A9A0, 0x48, 0x10, 0x38F0, 0x00, 0x90, 0x40;
}

state("Froghop", "2.4.4.0")
{
	int room : 0x0089B4C8;
	double gameTimer : 0x006715A0, 0x1F18, 0x48, 0x10, 0x40, 0x100;
	double isPaused : 0x006715A0, 0x1F18, 0x48, 0x10, 0x40, 0x40;
...
state("Froghop", "2.4.3.0")
{
	int room : 0x0089B4C8;
	double gameTimer : 0x006715A0, 0x1E70, 0x48, 0x10, 0x40, 0x3D0;
	double isPaused : 0x006715A0, 0x1E70, 0x48, 0x10, 0x40, 0x40;
	double levelComplete : 0x006715A0, 0x1E70, 0x48, 0x10, 0x40, 0x10;
	double gemCount : 0x0068A9A0, 0x48, 0x10, 0x1920, 0x00;
	double gem1 : 0x0068A9A0, 0x48, 0x10, 0x3430, 0x00, 0x90, 0x00;
	double gem2 : 0x0068A9A0, 0x48, 0x10, 0x3430, 0x00, 0x90, 0x10;
	double gem3 : 0x0068A9A0, 0x48, 0x10, 0x3430, 0x00, 0x90, 0x20;
	double gem4 : 0x0068A9A0, 0x48, 0x10, 0x3430, 0x00, 0x90, 0x30;
	double gem5 : 0x0068A9A0, 0x48, 0x10, 0x3430, 0x00, 0x90, 0x40;
}

state("Froghop", "2.4.2.0")
{
	int room : 0x0076A5A8;
	double gameTimer : 0x007772C0, 0x30, 0x348, 0x1E0;
	double isPaused : 0x007772C0, 0x30, 0x348, 0x130;
	double levelComplete : 0x007772C0, 0x30, 0x348, 0x100;
	double gemCount : 0x007772C0, 0x30, 0x1A40, 0x00;
	double gem1 : 0x007772C0, 0x30, 0x2E8C, 0x00, 0x64, 0x00;
	double gem2 : 0x007772C0, 0x30, 0x2E8C, 0x00, 0x64, 0x10;
	double gem3 : 0x007772C0, 0x30, 0x2E8C, 0x00, 0x64, 0x20;
	double gem4 : 0x007772C0, 0x30, 0x2E8C, 0x00, 0x64, 0x30;
	double gem5 : 0x007772C0, 0x30, 0x2E8C, 0x00, 0x64, 0x40;
}

state("Froghop", "2.4.1.0")
{
	int room : 0x0076A5A8;
	double gameTimer : 0x007772C0, 0x30, 0x348, 0x200;
	double isPaused : 0x007772C0, 0x30, 0x348, 0x150;
	double levelComplete : 0x007772C0, 0x30, 0x348, 0x120;
	double gemCount : 0x007772C0, 0x30, 0x5F4, 0x00;
	double gem1 : 0x007772C0, 0x30, 0x1A40, 0x00, 0x64, 0x00;
	double gem2 : 0x007772C0, 0x30, 0x1A40, 0x00, 0x64, 0x10;
	double gem3 : 0x007772C0, 0x30, 0x1A40, 0x00, 0x64, 0x20;
	double gem4 : 0x007772C0, 0x30, 0x1A40, 0x00, 0x64, 0x30;
	double gem5 : 0x007772C0, 0x30, 0x1A40, 0x00, 0x64, 0x40;
}

state("Froghop", "2.4.0.0")
{
	int room : 0x0076A5A8;
	double gameTimer : 0x007772C0, 0x30, 0x348, 0x200;
	double isPaused : 0x007772C0, 0x30, 0x348, 0x150;
...
state("Froghop", "2.3.0.0")
{
	int room : 0x00769598;
	double gameTimer : 0x007762B0, 0x30, 0x3C0, 0x810;
	double isPaused : 0x007762B0, 0x30, 0x3C0, 0x760;
	double levelComplete : 0x007762B0, 0x30, 0x3C0, 0x730;
	double gemCount : 0x005590C0, 0x24, 0x10, 0x21F0, 0x00;
	double gem1 : 0x007762B0, 0x30, 0x63C, 0x00, 0x64, 0x00;
	double gem2 : 0x007762B0, 0x30, 0x63C, 0x00, 0x64, 0x10;
	double gem3 : 0x007762B0, 0x30, 0x63C, 0x00, 0x64, 0x20;
	double gem4 : 0x007762B0, 0x30, 0x63C, 0x00, 0x64, 0x30;
	double gem5 : 0x007762B0, 0x30, 0x63C, 0x00, 0x64, 0x40;
}

state("Froghop", "2.2.1.0")
{
	int room : 0x006F9C30;
	double gameTimer : 0x00707918, 0x30, 0x960, 0x70;
	double isPaused : 0x00707918, 0x30, 0x1F8, 0x40;
	double levelComplete : 0x00707918, 0x30, 0x1F8, 0x00;
	double gemCount : 0x00707918, 0x30, 0x150, 0x90;
	double gem1 : 0x0070791C, 0x850, 0x64, 0x00;
	double gem2 : 0x0070791C, 0x850, 0x64, 0x10;
	double gem3 : 0x0070791C, 0x850, 0x64, 0x20;
	double gem4 : 0x0070791C, 0x850, 0x64, 0x30;
	double gem5 : 0x0070791C, 0x850, 0x64, 0x40;
}

state("Froghop", "2.2.0.0")
{
	int room : 0x00722248;
	double gameTimer : 0x00511D80, 0x2C, 0x10, 0xDB0, 0x00;
	double isPaused : 0x00511D80, 0x2C, 0x10, 0x1FE0, 0x00;
	double levelComplete : 0x00511D80, 0x2C, 0x10, 0x1878, 0x00;
	double gemCount : 0x00511D80, 0x2C, 0x10, 0x126C, 0x00;
	double gem1 : 0x00511D80, 0x2C, 0x10, 0x26A0, 0x00, 0x6C, 0x00;
	double gem2 : 0x00511D80, 0x2C, 0x10, 0x26A0, 0x00, 0x6C, 0x10;
	double gem3 : 0x00511D80, 0x2C, 0x10, 0x26A0, 0x00, 0x6C, 0x20;
	double gem4 : 0x00511D80, 0x2C, 0x10, 0x26A0, 0x00, 0x6C, 0x30;
	double gem5 : 0x00511D80, 0x2C, 0x10, 0x26A0, 0x00, 0x6C, 0x40;
}

state("Froghop", "2.1.1.0")
{
	int room : 0x017B9150;
	double gameTimer : 0x017AB240, 0x54C, 0x2C, 0x10, 0x90, 0x3C0;
	double isPaused : 0x017AB240, 0x54C, 0x2C, 0x10, 0x90, 0x0330;
	double levelComplete : 0x017AB240, 0x54C, 0x2C, 0x10, 0x90, 0x310;
	double gemCount : 0x017AB240, 0x54C, 0x34C, 0x2C, 0x10, 0x30, 0x20;
	double gem1 : 0x017A71F4, 0x30, 0x288, 0x60, 0x6C, 0x00;
	double gem2 : 0x017A71F4, 0x30, 0x288, 0x60, 0x6C, 0x10;
	double gem3 : 0x017A71F4, 0x30, 0x288, 0x60, 0x6C, 0x20;
	double gem4 : 0x017A71F4, 0x30, 0x288, 0x60, 0x6C, 0x30;
	double gem5 : 0x017A71F4, 0x30, 0x288, 0x60, 0x6C, 0x40;
}

state("Frog Hop", "2.0.0.0")
{
	int room : 0x006EFE10;
	double gameTimer : 0x004CE070, 0x00, 0x2C, 0x10, 0x2FC4, 0x00;
	double isPaused : 0x004E0AB0, 0x428, 0x50, 0x2C, 0x10, 0x00, 0x07E0;
	double levelComplete : 0x004E0AB0, 0x53C, 0x30, 0x2C, 0x10, 0x00, 0x360;
	double gemCount : 0x004E0AB0, 0x53C, 0x30, 0x2C, 0x10, 0x00, 0x420;
	double gem1 : 0x006FCAF4, 0x30, 0x1218, 0x00, 0x6C, 0x00;
	double gem2 : 0x006FCAF4, 0x30, 0x1218, 0x00, 0x6C, 0x10;
	double gem3 : 0x006FCAF4, 0x30, 0x1218, 0x00, 0x6C, 0x20;
	double gem4 : 0x006FCAF4, 0x30, 0x1218, 0x00, 0x6C, 0x30;
	double gem5 : 0x006FCAF4, 0x30, 0x1218, 0x00, 0x6C, 0x40;
}
...
update
{
	...
	if (vars.level == 0 && settings.ContainsKey("level_" + current.room) && settings["level_" + current.room] == true)
	{
