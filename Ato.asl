...
{
	int room : 0x00A3FCF4;
	double gameTimer : 0x0082FC70, 0x48, 0x10, 0x52C0, 0xE0;
	double difficulty : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x150;
	double phase : 0x0082FC70, 0x48, 0x10, 0x52C0, 0xD0;
	double orb1 : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x100, 0x90, 0x00;
	double orb2 :0x0082FC70, 0x48, 0x10, 0x52C0, 0x100, 0x90, 0x10;
	double orb3 : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x100, 0x90, 0x20;
	double win : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x70, 0x90, 0x200;
	double bossrush : 0x0082FC70, 0x48, 0x10, 0x3F10, 0x00;
	double grasscut : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x40;
	double talismans :0x0082FC70, 0x48, 0x10, 0x52C0, 0x170;
	double maxMP : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x180;
	double coinCount : 0x0082FC70, 0x48, 0x10, 0x52C0, 0x1C0;
}
state("Ato", "1.1.4.0")
{
	int room : 0x0088E0C8;
...
init
{
	...
	switch(version)
	{
		...
		case "1.1.5.0":
		default:
			abilityOffsets = new int[] {0x0082FC70, 0x48, 0x10, 0x52C0, 0x140, 0x90};
			achievementOffsets = new int[] {0x0082FC70, 0x48, 0x10, 0x52C0, 0x70, 0x90};
			runeOffsets = new int[] {0x0082FC70, 0x48, 0x10, 0x52C0, 0xA0, 0x90};
			break;
	}
