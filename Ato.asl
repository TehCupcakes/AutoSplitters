...
{
	int room : 0x01753BD0;
	double gameTimer : 0x017459A0, 0x48, 0x10, 0x1F00, 0xE0;
	double difficulty : 0x017459A0, 0x48, 0x10, 0x1F00, 0x480;
	double fileCreated : 0x017459A0, 0x48, 0x10, 0x1F00, 0x150;
	double phase : 0x017459A0, 0x48, 0x10, 0x1F00, 0x270;
	double orb1 : 0x017459A0, 0x48, 0x10, 0x1F00, 0x40, 0x08, 0x00;
	double orb2 : 0x017459A0, 0x48, 0x10, 0x1F00, 0x40, 0x08, 0x10;
	double orb3 : 0x017459A0, 0x48, 0x10, 0x1F00, 0x40, 0x08, 0x20;
	double win : 0x017459A0, 0x48, 0x10, 0x1F00, 0x10, 0x08, 0x200;
	double bossrush : 0x017459A0, 0x48, 0x10, 0x7C20, 0x00;
	double grasscut : 0x017459A0, 0x48, 0x10, 0x1F00, 0xA0;
	double talismans : 0x017459A0, 0x48, 0x10, 0x1F00, 0x220;
	double maxMP : 0x017459A0, 0x48, 0x10, 0x1F00, 0x230;
	double coinCount : 0x017459A0, 0x48, 0x10, 0x1F00, 0x130;
}
state("Ato", "1.1.10.0")
{
	int room : 0x00DBD0B8;
...
init
{
	...
	switch(version)
	{
		...
		case "1.1.11.0":
		default:
			abilityOffsets = new int[] {0x017459A0, 0x48, 0x10, 0x1F00, 0x50, 0x08};
			achievementOffsets = new int[] {0x017459A0, 0x48, 0x10, 0x1F00, 0x10, 0x08};
			runeOffsets = new int[] {0x017459A0, 0x48, 0x10, 0x1F00, 0x20, 0x08};
			break;
	}
